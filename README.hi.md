...
| **Dashboard** | एक एस्ट्रो-आधारित वेब एप्लिकेशन, जिसमें पल्स एआई सह-पायलट (आवाज आउटपुट, फुलस्क्रीन, गिटहब डेटा कनेक्टर्स), छह इंटरैक्टिव चार्ट, लाइव रीफ्रेश, रिपोर्ट एक्सपोर्ट (पीडीएफ/JSONL/मार्कडाउन) और टैब्ड हेल्प गाइड शामिल हैं। यह साप्ताहिक रूप से CI द्वारा पुनर्निर्मित किया जाता है; आवश्यकतानुसार रीफ्रेश किया जा सकता है। |
...
- **पल्स एआई सह-पायलट** — ओलामा-आधारित संवादात्मक सहायक जिसमें आवाज आउटपुट (4 आवाजें [mcp-voice-soundboard](https://github.com/mcp-tool-shop-org/mcp-voice-soundboard) के माध्यम से), ऑटो-स्पीक, फुलस्क्रीन मोड, गिटहब ऑर्ग डेटा कनेक्टर, स्ट्रीमिंग प्रतिक्रियाएं, मॉडल चयनकर्ता और संवादात्मक मेमोरी शामिल है।
- **एग्जीक्यूटिव स्नैपशॉट** — स्वास्थ्य स्कोर (0-100), विविधता सूचकांक, साप्ताहिक परिवर्तन, सभी रजिस्ट्री में कुल डाउनलोड
- **छह इंटरैक्टिव चार्ट** — 30-दिन का ट्रेंड (एकत्रित/प्रति-रजिस्ट्री/शीर्ष-5 विकल्प), रजिस्ट्री शेयर (ध्रुवीय क्षेत्र), पोर्टफोलियो जोखिम (हिस्टोग्राम + गिनी और P90), शीर्ष-10 मोमेंटम, वेलोसिटी ट्रैकर जिसमें स्पार्कलिन शामिल हैं, और 30-दिन का हीटमैप जिसमें स्पाइक डिटेक्शन (>2σ) शामिल है।
- **स्मार्ट ग्रोथ इंजन** — बेसलाइन थ्रेशोल्ड, प्रतिशत कैप और डैम्प्ड वेलोसिटी फॉर्मूला के साथ छोटे-पैमाने के विकृति को संभालता है।
- **कार्यात्मक अंतर्दृष्टि** — घटते पैकेजों के लिए ऑटो-जनरेटेड सिफारिशें और अलर्ट।
- **पल्स पैनल** — स्थापित और लोकप्रिय (≥ 50 डाउनलोड/सप्ताह) और उभरते हुए और नए पैकेजों का विभाजित दृश्य, जिसमें इनलाइन 7-दिन के स्पार्कलिन, निरपेक्ष + प्रतिशत अंतर, बेसलाइन संदर्भ और एक-पंक्ति का कार्यकारी सारांश शामिल है।
- **लाइव रीफ्रेश** — एनपीएम और पाइपीआई एपीआई से ऑन-डिमांड क्लाइंट-साइड फेच, जिसमें प्रगति संकेतक है; परिणाम sessionStorage में कैश किए जाते हैं (5 मिनट TTL), इसलिए टैब स्विच तुरंत होते हैं।
- **रिपोर्ट एक्सपोर्ट** — रीफ्रेश बटन के बगल में एक ड्रॉपडाउन मेनू, जो तीन प्रारूप प्रदान करता है: **एग्जीक्यूटिव पीडीएफ** (jsPDF के माध्यम से), **एलएलएम JSONL** (एआई इनपुट के लिए टाइप किए गए रिकॉर्ड), और **डेवलपर मार्कडाउन** (GFM टेबल)।
...
- **सेटअप पेज** — सत्यापन के साथ पोर्टफोलियो संपादक, रजिस्ट्री-सिंक साथी अनुभाग और पाइपलाइन अवलोकन।
- **हेल्प टैब** — हर टैब, प्रमुख अवधारणाओं, एआई सहायक युक्तियों, डेटा पाइपलाइन और उपयोगी लिंक को कवर करने वाला उपयोगकर्ता-अनुकूल गाइड।
- **डार्क/लाइट थीम** — सिस्टम वरीयता का पालन करता है।

डेटा बिल्ड टाइम पर प्राप्त किया जाता है और साप्ताहिक रूप से CI (सोमवार सुबह 6:00 यूटीसी) द्वारा पुनर्निर्मित किया जाता है। लाइव रीफ्रेश सीधे रजिस्ट्री एपीआई से नवीनतम आंकड़े प्राप्त करता है। ट्रैक किए गए पैकेजों को `site/src/data/packages.json` में कॉन्फ़िगर करें (5 रजिस्ट्री में 132 पैकेज)।
